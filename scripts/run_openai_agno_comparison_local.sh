...
DEFAULT_STAGE2_MODEL_PROVIDER="$(PYTHONPATH="$ROOT_DIR/src" "$PYTHON_BIN" -c 'from cas.llm.model_catalog import stage2_single_model_default; print(stage2_single_model_default().provider)')"
DEFAULT_STAGE2_MODEL_NAME="$(PYTHONPATH="$ROOT_DIR/src" "$PYTHON_BIN" -c 'from cas.llm.model_catalog import stage2_single_model_default; print(stage2_single_model_default().model)')"
MODEL_PROVIDER="${CAS_STAGE2_MODEL_PROVIDER:-$DEFAULT_STAGE2_MODEL_PROVIDER}"
MODEL_NAME="${CAS_STAGE2_MODEL:-$DEFAULT_STAGE2_MODEL_NAME}"
...
SAMPLES_PATH="data/outputs/modeling/feature_46_xgboost/diagnostics/stage2_agents/committee_review_holdout_unseen_8_samples.csv"
POLICY="balanced_current_45_or_near_threshold_0_10"
DETERMINISTIC_DIR="data/outputs/modeling/feature_46_xgboost/diagnostics/stage2_agents/committee_review_openai_agno_comparison_deterministic"
AGNO_DIR="data/outputs/modeling/feature_46_xgboost/diagnostics/stage2_agents/committee_review_openai_agno_comparison_agno"
...
echo "- data/outputs/modeling/feature_46_xgboost/diagnostics/stage2_agents/stage2_openai_agno_explanation_comparison.md"
echo "- data/outputs/modeling/feature_46_xgboost/diagnostics/stage2_agents/stage2_evaluation_report.md"
