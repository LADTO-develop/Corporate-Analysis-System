...
- Speed: wall `95.4372` sec, mean case `22.343` sec, throughput `5.0295` cases/min
- Stage 2 LLM speed: mean `20.3821` sec, max `38.9918` sec, cache hits `0`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| true_negative_overescalation_guardrail | (주)엔에프씨 |  | 투자적격 | 투자적격 | 적격 | tn_kept_eligible | ready | 7 |
