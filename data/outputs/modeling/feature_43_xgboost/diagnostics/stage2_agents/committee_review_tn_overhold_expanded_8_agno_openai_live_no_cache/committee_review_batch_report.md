...
- Rows: 8
- Strict committee success rate: 25.0%
- Review-safe success rate: 100.0%
- Speed: wall `87.9967` sec, mean case `20.4052` sec, throughput `5.4548` cases/min
- Stage 2 LLM speed: mean `18.3034` sec, max `26.2671` sec, cache hits `0`
...
| true_negative_overescalation_guardrail | (주)머큐리 |  | 투자적격 | 투자적격 | 보류 | tn_escalated | ready | 6 |
